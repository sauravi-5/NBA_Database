...
st.markdown(
    """
    <div style="width: 100%; height: 300px; border: 2px solid white; margin-top: 20px; text-align: center; display: flex; align-items: center; justify-content: center;">
        <p style="color: grey;">The desired output will be displayed here.</p>
    </div>
    """,
    unsafe_allow_html=True,
)
