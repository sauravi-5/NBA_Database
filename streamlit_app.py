...
st.markdown(
    ...
    <div style="border: 2px solid white; padding: 20px; text-align: center; font-size: 20px;">
        ...
        <div style="display: flex; justify-content: space-around; margin-top: 20px;">
            <div style="border: 1px solid black; padding: 20px; width: 20%; background-color: #f9f9f9; display: flex; flex-direction: column; align-items: center; justify-content: center;">
